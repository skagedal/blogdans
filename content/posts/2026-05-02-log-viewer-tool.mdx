...
I guess I spent _some_ small amount of time searching the web for such a tool, but quickly decided to just roll my own. Please let me know what I missed. Here's what it ended up looking like:

<Asciinema
  src="/casts/log-viewer.cast"
  alt="A short recording of log-viewer browsing JSONL logs: scrolling, filtering, and opening an entry's detail view."
/>
